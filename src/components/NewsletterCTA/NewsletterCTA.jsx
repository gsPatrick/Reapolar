...
function NewsletterCTA() {
    return (
        <section className="newsletter-cta-section newsletter-cta-section--blue"> {/* Added whatsapp-cta-section--blue class */}
            <div className="container newsletter-cta-container newsletter-cta-container--blue"> {/* Added whatsapp-cta-container--blue class */}
                ...
                <button className="newsletter-cta-button newsletter-cta-button--blue">EU QUERO!</button> {/* Updated button text and added whatsapp-cta-button--blue */}
            </div>
        </section>
    );
}
